...
<ion-app id="app-container">
        ...
        <ion-content id="content-container">
            ...
            <ion-card>
                <ion-card-content>
                    <form method="post" action="agendarturnopaciente">
                        <ion-item>
                        ...
                        <ion-button type="submit" class="confirm-button" expand="block">Agendar</ion-button>
